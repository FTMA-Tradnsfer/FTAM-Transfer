...
const MARKET_CACHE_KEY='ftma_market_players_v4',MARKET_CACHE_TTL=120000;
async function loadPlayers(){
  ...
  const r=await timeout(db.from('players').select('id,name,photo_url,nationality,position,market_value,age,shirt_number,current_club_id,is_loan,is_nfs,is_fa,clubs(id,name)').eq('is_loan',false).eq('is_nfs',false).order('market_value',{ascending:false}));
